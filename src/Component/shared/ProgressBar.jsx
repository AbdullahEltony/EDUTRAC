export default function ProgressBar() {
    return (
        <div className="sticky top-0 xl:top-[13.75rem] z-50 xl:z-10 max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-6xl w-full h-8 bg-gray-300 rounded-full overflow-hidden mx-auto mb-10">
