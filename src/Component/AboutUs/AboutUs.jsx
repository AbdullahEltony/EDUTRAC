    ...
    <div className='w-full flex flex-row'>
        <div className="w-1/5 bg-[#d9e7f1] p-4 h-screen flex flex-col justify-between fixed">
            <div className="flex flex-col gap-4">
                ...
                <NavLink to={'/home'} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })} className="p-3 rounded-[20px]">
                ...
                <NavLink to={'/aboutus'} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })} className="p-3 bg-[#eff4f8] rounded-[20px]">
                    <div className='flex items-center gap-2.5'>
        ...
        <div className='w-4/5 mr-[21%] mt-[15%]'>
