...
const LevelNote = ({note,handleSubmit,formik2,setNote,loading}) => {
    return (
        <div className="mx-2 md:mx-0 mt-8 text-right py-4 sm:px-0 ">
            ...
            <button disabled={loading} onClick={() => { handleSubmit(); formik2.handleSubmit; }} className="w-full rounded-xl mt-2.5 py-3 bg-[#EFF4F8] text-black text-[18px] md:text-2xl cursor-pointer duration-200">{loading ? 'جاري الحفظ':'حفظ الملاحظة'} </button>
