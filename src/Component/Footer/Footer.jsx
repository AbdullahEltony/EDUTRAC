...
export default function Footer(){
  return <>
    <div className='mr-[20%]'>
      <div className="bg-[#191A1B] text-white py-10 px-6 md:px-20 mr-3">
        <div className="grid grid-cols-12 text-left">
          ...
          <div  className="col-span-12 md:col-span-2">
            ...
            <ul className="space-y-1 text-sm text-gray-300">
              <li><NavLink to={"/home"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })}>Home</NavLink></li>
              <li><NavLink to={"/updateCourses"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })}>Courses</NavLink></li>
              <li><NavLink to={"/finalCourses"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })}>Final Courses</NavLink></li>
              <li><NavLink to={"/aboutus"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })}>About us</NavLink></li>
              <li><NavLink to={"/profile"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })}>Profile</NavLink></li>
              <li><NavLink to={"/chatBot"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" , block: 'center' })}>ChatBot</NavLink></li>
            </ul>
          </div>
