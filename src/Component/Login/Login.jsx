    ...
    return <>
        <motion.div
            ...
            <div className={`absolute flex flex-row-reverse bg-white overflow-hidden shadow-lg w-[93%] max-w-4xl rounded-tr-[0px] sm:rounded-tr-[2.5rem] rounded-bl-[2.5rem] sm:rounded-bl-[0px] rounded-br-[2.5rem]`}>
                ...
                <div className={`text-white h-46 sm:h-full w-full sm:w-1/3 md:w-1/4 p-8 flex flex-col justify-center text-center absolute top-0 left-0 bottom-0 transition-all duration-10000 ease-in-out ${isActive ? "left-[-100%]" : "left-0"}`}>
